                    ...
                    <div key={index} className="relative h-[400px] md:h-[600px] w-full">
                        ...
                        <div className="relative z-10 flex flex-col justify-center items-center text-center h-full px-2 sm:px-4 text-white">
                            <Slide direction="down" triggerOnce>
                                ...
                                <Link
                                    to="/allArtifacts"
                                    className="mt-6 px-4 sm:px-6 py-2 btn bg-gradient-to-r from-yellow-950 via-orange-900 to-red-950 text-base sm:text-lg text-white font-bold rounded-lg border-yellow-950"
                                >
                                    Explore Artifacts
                                </Link>
                            </Slide>
